...
namespace otomasyonproje
{
    ...
    public partial class frmMenu2 : Form
    {
        ...
        private void AyrıntılıSiparişFormunuAç(string masaAdi)
        {
            frmSiparis2 siparisFormu = new frmSiparis2(masaAdi);
            this.Hide();
            siparisFormu.Show();
        }
        ...
        private void btnMasa1_Click_1(object sender, EventArgs e)
        {
            AyrıntılıSiparişFormunuAç("Masa 1");
        }

        private void btnMasa2_Click_1(object sender, EventArgs e)
        {
            AyrıntılıSiparişFormunuAç("Masa 2");
        }

        private void btnMasa3_Click_1(object sender, EventArgs e)
        {
            AyrıntılıSiparişFormunuAç("Masa 3");
        }
    }
}
